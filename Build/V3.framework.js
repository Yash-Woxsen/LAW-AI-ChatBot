...
var ASM_CONSTS = {
  4332988: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4333043: ($0) => { performance.now = function() { return $0; }; },  
 4333091: ($0) => { performance.now = function() { return $0; }; },  
 4333139: () => { performance.now = Module['emscripten_get_now_backup']; }
};
